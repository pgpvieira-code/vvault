...
The VVault server (the API, the Admin app and the web app/client) is built entirely with [.NET 10](https://dotnet.microsoft.com/) and [Blazor WebAssembly](https://learn.microsoft.com/aspnet/core/blazor/).
