...
---
# iOS
This article covers iOS specific parts of the React Native VelixVault app codebase.
...
This static encrypted database can be (re)generated by running the `apps/server/Tests/VelixVault.E2ETests/Tests/Extensions/TestVaultGeneratorTests.cs` in the .NET solution. This E2E test generates a deterministic vault and saves it to a local temporary file. This file can then be used as the input for these unittests.
